<?php
  ...
  $result =  mysqli_query($conn,"SELECT * FROM profile_text WHERE Jenis='Doktrin'")
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div style="width:100%; margin-top:7%;">
    <h1 style="text-align:center; padding: 10% 0 5% 0; font-weight:bold;">Doktrin Kejaksaan</h1>
    <div class="container card">
    <div class="card-header">
    <h3>Trikrama Adhyaksa</h3>
    </div>
    <div class="card-body">
    <?php
