<?php
  ...
  $result =  mysqli_query($conn,"SELECT * FROM profile_img WHERE Jenis='Struktur'")
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div style="width:100%; margin-top:7%;">
    <h1 style="text-align:center; padding: 10% 0 5% 0; font-weight:bold;">Struktur Organisasi</h1>
    <?php
    while($row=mysqli_fetch_assoc($result)){
    echo '<img src="'.$row["Gambar"].'" style="width: 100%;" alt="">';
    } ?>
</div>
