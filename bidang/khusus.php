<?php
      ...
      $result = mysqli_query($conn,"SELECT*FROM informasi_bidang WHERE Jenis='khusus'");
  ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<h1 style="text-align:center; padding: 13% 0 5% 0; font-weight:bold;">Kasus Pidana Khusus</h1>
