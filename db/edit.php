<?php
    ...
    if(isset($_POST["tambah"])){
        ...
        $query = "UPDATE berita SET  Judul='$judul' ,Waktu = '$tanggal', Isi = '$isi' WHERE Judul='$judul'";
...
<div class="container">
    ...
    <br>
    Judul
    <input type="text" name="judul">'.$row["Judul"].'
    <br>
    Tanggal
    <input type="date" name="tanggal">'.$row["Tanggal"].'
    <br>
    Isi
